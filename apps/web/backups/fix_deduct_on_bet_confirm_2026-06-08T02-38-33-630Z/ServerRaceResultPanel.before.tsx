...
export function ServerRaceResultPanel({
  ...
  const isWaitingForTicketResult = hasLocalTicket && !serverPlayerResult;
  const hasTicket = hasServerTicket;
    ...
    <section className="server-results-fullscreen">
      ...
      <div className="result-panel-compact server-results-panel">
        ...
        <div className={'result-coins-box ' + resultClass}>
          ...
          {isWaitingForTicketResult ? (
            <>
              <strong>...</strong>
              <span>Consultando el resultado económico de tu boleto...</span>
            </>
          ) : !hasTicket ? (
            <>
              <strong>0</strong>
