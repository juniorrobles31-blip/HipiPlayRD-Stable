...
import { getServerRaceState, ServerRaceState, getServerRaceHistory, ServerPublicRaceHistory, sendServerBet } from './hipiplayServerApi';
...
useEffect(() => {
  ...
  async function bet() {
    ...
    if (wallet && (wallet.demoBalance || 0) < safeAmount) {
