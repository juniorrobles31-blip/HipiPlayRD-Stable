  ...
  return (
    <section className="race-video-engine">
      ...
      <div className="race-video-stage">
        ...
        {!isStarted && (
          <div className="race-video-start-panel">
            <h2>Carrera lista</h2>
            <p>
              El video se reproducirá con máscaras visuales para tapar nombres, marcas o datos externos.
            </p>
      ...
      <div className="race-video-footer">
        ...
        <div>
          <span>Close-up termina en</span>
          <strong>{selectedTemplate.closeUpEnd}s</strong>
        </div>

        <div>
          <span>Máscaras activas</span>
          <strong>{selectedTemplate.maskAreas?.length || 0}</strong>
        </div>
      </div>
    </section>
  );
