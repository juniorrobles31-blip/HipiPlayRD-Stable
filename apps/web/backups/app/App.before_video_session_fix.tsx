  ...
  return <div className="player-screen">
    ...
    <section className="game-hero glass cycle-hero">
      ...
      <div className="cycle-status">
        ...
        <strong>{cycle.phase === 'betting' ? 'Apuestas abiertas' : cycle.phase === 'running' ? 'Carrera en vivo' : 'Resultado oficial'}</strong>
    ...
    <div className="cycle-steps glass">
      ...
      <div className="step-line"></div>
      <div className={cycle.phase === 'result' ? 'step active' : lastResult ? 'step done' : 'step'}><span>03</span><strong>Resultado</strong><small>10 segundos</small></div>
    </div>
    ...
    {cycle.phase === 'running' ? (
      <RaceVideoEngine
        ...
        autoPlay
        startAtSeconds={Math.floor(cycle.phaseElapsed / 1000)}
        onFinish={() => {
          console.log('RaceVideoEngine terminó:', cycle.raceId, resultOrder.slice(0, 3));
        }}
      />
    ) : (
      <RaceTrack
